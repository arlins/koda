...
| `base/kd_anyfunction.h`| Store and call any function. |
...
| Component | Description |
| :--- | :--- |
| `ipc/kd_ipc.h` | IPC connection implementation. |
...
| Component | Description |
| :--- | :--- |
| `runloop/kd_runloop.h` | Cross-platform event loop. |
...
For simple modules, please refer to the module's APIs. For complex modules, please refer to the corresponding `xxx_test.h` file. For example, to use the ipc module, please refer to the kd_ipc_test.h file. 

Because these are header-only files, the APIs may appear numerous in complex modules. Please focus on the public functions of the classes. 
